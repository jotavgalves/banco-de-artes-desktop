...
function showLocalBackupPickerModal(files) {
  return new Promise((resolve) => {
    ...
    // Ajuste 3: padding 0 para poder alinhar 24px em cada subdivisao
    ...
    divider1.style.cssText = "height: 1px; background: var(--line, #e2e8f0); margin-bottom: 20px;";
    ...
    // Bottom Space Container (Ajuste 4)
    const bottomSpace = document.createElement("div");
    bottomSpace.style.cssText = "margin-top: 20px;"; // 20px de espaço acima do divider do rodapé
